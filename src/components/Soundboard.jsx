...
function Soundboard( { icon, sound, keybind, soundName, kickIcon, clHiHatIcon, opHiHatIcon, snareIcon } ) {
  ...
  return (
    <div className="soundboard">
        <SoundboardButton icon={kickIcon} sound={kickSound} keybind={"q"} soundName={"Kick"}/>
        <SoundboardButton icon={clHiHatIcon} sound={clHiHatSound} keybind={"w"} soundName={"Closed Hi-hat"}/>
        <SoundboardButton icon={opHiHatIcon} sound={opHiHatSound} keybind={"e"} soundName={"Open Hi-hat"}/>
        <SoundboardButton icon={snareIcon} sound={snareSound} keybind={"r"} soundName={"Snare"}/>
    </div>
  )
}
